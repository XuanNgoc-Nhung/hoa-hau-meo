            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Danh sách diễn đàn - {{ $danhMuc->ten_danh_muc }}</h4>
                    </div>
                    <div class="card-body">
                        @if($dienDan->count() > 0)
                            <div class="table-responsive">
                                <table class="table table-hover table-bordered">
                                    {{-- <thead class="table-light">
                                        <tr>
                                            <th>Thông tin diễn đàn</th>
                                            <th style="width: 200px;">Thống kê</th>
                                            <th style="width: 180px;">Người đăng & Thời gian</th>
                                        </tr>
                                    </thead> --}}
                                    <tbody>
                                        @foreach($dienDan as $dien)
                                            <tr>
                                                <td>
                                                        ...
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <h5 class="mb-2 fw-bold">
                                                                ...
                                                                <small class="text-success ms-2 fst-italic" style="font-size: 0.75rem;">
                                                                    ...
                                                                    Last updated: {{ $dien->updated_at->diffForHumans() }}
                                                                </small>
                                                            </h5>
                                                ...
                                                <td>
                                                    <div class="d-flex flex-column text-muted small">
                                                        <div class="mb-1">
                                                            ...
                                                            <span>{{ $dien->luot_xem ?? rand(10, 500) }} lượt xem</span>
                                                        </div>
                                                        <div>
                                                            <i class="fas fa-comments me-2 text-success"></i>
                                                            <span>{{ $dien->luot_comment ?? rand(0, 50) }} bình luận</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex flex-column text-muted small">
                                                        <div class="mb-1">
                                                            ...
                                                            <span>{{ $dien->nguoi_tao ?? 'Admin' }}</span>
                                                        </div>
                                                        <div class="mb-1">
